...
export interface CbseSessionData extends SessionData {
  classLevel: ClassLevel | null;          // Class/grade level
  questionPaper: string | null;           // The question paper text
  questionMarks: Map<number, number> | null; // Question number to marks mapping
  isMarkingConfirmed: boolean;            // Whether marks distribution is confirmed
}
